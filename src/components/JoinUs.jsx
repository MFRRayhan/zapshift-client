  ...
  return (
    <main className="container">
      <section className="relative overflow-hidden rounded-3xl bg-[#033636] text-white px-6 py-10 md:px-12 md:py-16 flex flex-col md:flex-row items-center">
        {/* Content */}
        <FadeInUp className="relative z-10 w-full md:w-3/5 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <HoverScale>
              <Link to={"/earn-with-courier"} className="btn btn-outline w-full sm:w-auto text-white border-white hover:bg-white hover:text-[#033636]">
                Earn with Courier
              </Link>
            </HoverScale>
          </div>
        ...
        {/* Image */}
        <FadeInUp delay={0.2} className="relative z-10 w-full md:w-2/5 mt-10 md:mt-0 flex justify-center md:justify-end">
          <img
            src={joinUsImage}
